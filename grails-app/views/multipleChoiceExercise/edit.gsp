...
<head>
    ...
    <title>Feleletválasztós feladat szerkesztése</title>
</head>
<body>
<div class="row curriculum">
    <div class="small-12 columns">
        <h3>Feleletválasztós feladat szerkesztése</h3>
    </div>
    ...
    <div class="small-12 columns">
        ...
        <form action="<g:createLink action="update" />" id="createForm" method="post" class="custom" name="${formId}">
            ...
            <fieldset class="form">
                <g:render template="/multipleChoiceExercise/multiple_choice_form"/>
            </fieldset>
            <div class="row">
                <div class="small-12 columns">
