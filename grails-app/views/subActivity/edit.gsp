...
<head>
    ...
    <title>Al-tevékenység szerkesztése</title>
</head>

<body>
<div class="row curriculum">
    <div class="small-12 columns">
        <h3>Al-tevékenység szerkesztése</h3>
    </div>
    ...
    <div class="small-12 columns">
        <form action="<g:createLink action="update"/>" id="subactivityEditForm" method="post">
            <input type="hidden" name="id" value="${instance.id}"/>
            <input type="hidden" name="version" value="${instance.version}"/>
            <g:render template="subactivity_form"/>
            <div class="row">
                <div class="small-12 columns">
                    <a href="" class="button small blue radius" onclick="document.getElementById('subactivityEditForm').submit(); return false;">Mentés</a>
