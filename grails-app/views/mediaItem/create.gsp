        ...
        <div class="small-12 columns">
			<g:form action="save" >
                ...
                <g:if test="${params?.feedbackId}">
                    <g:link controller="feedback" action="edit" params="[id: params?.feedbackId]">Visszajelzés</g:link>
                ...
                <div class="row">
                    <div class="small-12 columns">
                        ...
                        <g:if test="${params.feedbackId}">
                            <g:link controller="feedback" action="edit" params="[id: params.feedbackId]" class="button small blue radius">Mégsem</g:link>
                        </g:if>
                        <g:if test="${params.answerId}">
