...
<head>
    ...
    <title>Feladat szerkesztése</title>
</head>
<body>
<div class="row curriculum">
    ...
    <div class="small-12 columns">
        <form action="<g:createLink action="update" />" id="exerciseEditForm" method="post" class="custom">
            <input type="hidden" name="id" value="${instance.id}" />
            <input type="hidden" name="version" value="${instance.version}" />
            <g:render template="exercise_form" />
            <div class="row">
                <div class="small-12 columns">
                    <a href="" class="button small blue radius" onclick="document.getElementById('exerciseEditForm').submit(); return false;">Mentés</a>
